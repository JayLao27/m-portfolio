...
function LayoutContent({ isDarkMode, toggleTheme }: { isDarkMode: boolean; toggleTheme: () => void }) {
  useScrollReveal()
    ...
    <LocomotiveScrollProvider>
      ...
      >
        ...
        <div className="relative z-10" data-scroll-section>
          ...
          {/* Footer */}
          <footer className={`relative z-10 py-12 text-center border-t ${isDarkMode ? 'border-white/5' : 'border-white/10'
            }`}>
...
function Layout() {
  ...
  return <LayoutContent isDarkMode={isDarkMode} toggleTheme={toggleTheme} />
}
