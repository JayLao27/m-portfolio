...
export function LeftIcons({ isDarkMode, showIcons }: { isDarkMode: boolean; showIcons: boolean }) {
  return (
    <div className={`absolute left-24 flex flex-row gap-6 py-4 max-md:static max-md:flex-col max-md:mb-8 max-md:right-auto max-md:pb-0 transition-all duration-700 ease-out ${
