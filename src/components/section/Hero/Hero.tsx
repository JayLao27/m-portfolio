    ...
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-[1000] backdrop-blur-md transition-all duration-500 ease-in-out ${showHeader && visible ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'
        ...
        <div className="flex items-center justify-between px-12 py-3 max-md:px-8 max-md:py-4">
          ...
          <nav className="header-nav flex items-center gap-8 max-md:gap-4">
            ...
            <button
              onClick={toggleTheme}
              className={`inline-flex bg-transparent border ${isDarkMode ? 'border-[rgba(136,146,176,0.2)] text-nav-text hover:bg-[rgba(136,146,176,0.2)]' : 'border-[rgba(255,255,255,0.2)] text-white hover:bg-[rgba(255,255,255,0.1)]'} px-2.5 py-2 rounded-xl cursor-pointer text-lg transition-all duration-500 hover:scale-110 hover:rotate-12 ${showHeader ? 'animate-slide-down-delay-2' : 'opacity-0'}`}
      ...
      <section className="hero-section min-h-screen flex items-center justify-center px-[10%] relative max-w-[1600px] mx-auto max-xl:px-[5%] max-md:px-[5%] overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="absolute top-20 left-10 w-72 h-72 bg-highlight/5 rounded-full blur-3xl animate-float"
            data-parallax="slow"
            data-parallax-speed="1.5"
          ></div>
          <div
            className="absolute bottom-20 right-10 w-96 h-96 bg-highlight/5 rounded-full blur-3xl animate-float"
            style={{ animationDelay: '2s' }}
            data-parallax="slow"
            data-parallax-speed="2"
          ></div>
          <div
            className="absolute top-1/3 left-1/2 w-64 h-64 bg-highlight/3 rounded-full blur-3xl animate-float"
        ...
        <div className="flex-1 max-w-[800px] text-center relative z-10">
          <div className="space-y-6">
            ...
            <h2
              className={`text-[2rem] font-['Syne'] font-semibold ${isDarkMode ? 'text-tagline-text' : 'text-[#F0F4FF]'} mb-6 leading-tight max-xl:text-[3rem] max-md:text-[2.5rem] max-sm:text-[2rem] transition-all duration-700 ease-out ${showText3 ? 'translate-y-0 opacity-100' : '-translate-y-8 opacity-0'}`}
              data-parallax="slow"
