  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className={`absolute top-1/4 left-0 w-[600px] h-[600px] rounded-full blur-3xl ${isDarkMode ? 'bg-highlight/5' : 'bg-[#1DD0A7]/5'} animate-float`} style={{ animationDelay: '1.5s' }} data-scroll data-scroll-speed="-2"></div>
        <div className={`absolute bottom-1/4 right-0 w-[500px] h-[500px] rounded-full blur-3xl ${isDarkMode ? 'bg-highlight/5' : 'bg-[#1DD0A7]/5'} animate-float`} data-scroll data-scroll-speed="1.5"></div>
      </div>

      {/* Header */}
      <div className="mb-16 text-center relative z-10 scroll-animate-subtle" >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 scroll-animate-subtle scroll-animate-delay-1" >
      ...
      {/* Bottom CTA */}
      <div className="mt-20 text-center relative z-10 scroll-animate-subtle scroll-animate-delay-2" >
