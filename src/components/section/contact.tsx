  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className={`absolute top-1/4 left-0 w-[600px] h-[600px] rounded-full blur-3xl ${isDarkMode ? 'bg-highlight/5' : 'bg-[#1DD0A7]/5'} animate-float`} style={{ animationDelay: '1.5s' }}></div>
        <div className={`absolute bottom-1/4 right-0 w-[500px] h-[500px] rounded-full blur-3xl ${isDarkMode ? 'bg-highlight/5' : 'bg-[#1DD0A7]/5'} animate-float`}></div>
      </div>
                ...
                >
                  ...
                  <svg 
                    className={`w-5 h-5 transition-transform duration-300 group-hover:translate-x-1 ${
                      isDarkMode ? 'text-highlight' : 'text-[#1DD0A7]'
                    }`}
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className={`w-full px-4 py-3 rounded-lg font-['DM_Sans'] transition-all duration-300 focus:outline-none focus:ring-2 ${
                  isDarkMode
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={6}
                className={`w-full px-4 py-3 rounded-lg font-['DM_Sans'] transition-all duration-300 focus:outline-none focus:ring-2 resize-none ${
                  isDarkMode
                    ? 'bg-white/5 border border-white/10 text-body-text placeholder-body-text/40 focus:ring-highlight/50 focus:border-highlight/50'
                    : 'bg-white/10 border border-white/20 text-white placeholder-white/40 focus:ring-[#1DD0A7]/50 focus:border-[#1DD0A7]/50'
                }`}
            ...
            <button
              ...
              className={`w-full px-8 py-4 rounded-full font-['JetBrains_Mono'] text-sm tracking-wider transition-all duration-500 flex items-center justify-center gap-3 ${
                isDarkMode
